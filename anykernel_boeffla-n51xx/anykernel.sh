...
do.modules=1
do.cleanup=1
device.name1=kona3gxx
device.name2=n5100
device.name3=kona3gjt
device.name4=n5105
device.name5=konawifixx
device.name6=5110
device.name7=konaltexx
device.name8=n5120
device.name9=GT-N5100
device.name10=GT-N5110
device.name11=GT-N5120
device.name12=GT-N5105
device.name13=
device.name14=
device.name15=
