			 ...
			 void *data)
{
	...
	if (is_v2) {
		/*
		 * Android userspace expects a cgroup2 mount at
		 * /sys/fs/cgroup even on legacy kernels. Provide an empty
		 * compatibility hierarchy backed by the existing cgroup core.
		 */
		memset(&opts, 0, sizeof(opts));
		opts.none = true;
	} else {
